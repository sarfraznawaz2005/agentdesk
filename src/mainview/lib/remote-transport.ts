...
const BROADCAST_EVENTS: Record<string, string> = {
  ...
  dashboardPMToolResult: "agentdesk:dashboard-pm-tool-result",
  ...
  dashboardAgentToolResult: "agentdesk:dashboard-agent-tool-result",
  ...
  generalChatRunStarted: "agentdesk:general-chat-run-started",
  generalChatPart: "agentdesk:general-chat-part",
  generalChatPartUpdated: "agentdesk:general-chat-part-updated",
  generalChatTextDelta: "agentdesk:general-chat-text-delta",
  generalChatPartsRemoved: "agentdesk:general-chat-parts-removed",
  generalChatComplete: "agentdesk:general-chat-complete",
  generalChatRunError: "agentdesk:general-chat-run-error",
  generalChatCompacted: "agentdesk:general-chat-compacted",
  generalChatConversationRenamed: "agentdesk:general-chat-conversation-renamed",
  generalChatStreamPerformance: "agentdesk:general-chat-stream-performance",
  generalChatContextUsage: "agentdesk:general-chat-context-usage",
