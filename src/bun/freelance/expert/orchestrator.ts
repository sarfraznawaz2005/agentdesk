...
const EXCLUDE_TOOLS = [
	// No direct human-input dialog — this runs autonomously (often when the user is away).
	// Use escalateToHuman/notify_human instead (inbox + desktop + channels, parks the job).
	"request_human_input",
