...
export const handlers: Record<string, (params: any) => any> = {
	...
	"freelance.expert.resolveAllEscalations": () => freelanceExpertRpc.resolveAllEscalations(),
	...
	generateAmbientSpeech: (params) => ambientRpc.generateAmbientSpeech(params.providerId, params.modelId, params.text, params.speed),
	...
	deleteAmbientLocalVoice: () => ambientRpc.deleteAmbientLocalVoice(),
	preloadAmbientLocalVoice: () => ambientRpc.preloadAmbientLocalVoice(),
	getAmbientLocalSttStatus: () => ambientRpc.getAmbientLocalSttStatus(),
	downloadAmbientLocalStt: () => ambientRpc.downloadAmbientLocalStt(),
	deleteAmbientLocalStt: () => ambientRpc.deleteAmbientLocalStt(),
	startAmbientLocalListening: () => ambientRpc.startAmbientLocalListening(),
	stopAmbientLocalListening: () => ambientRpc.stopAmbientLocalListening(),
