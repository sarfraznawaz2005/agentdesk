...
export const handlers: Record<string, (params: any) => any> = {
	...
	searchInboxMessages: (params) => inboxRpc.searchInboxMessages(params.query, params.projectId, params.isFavorite),
	...
	favoriteInboxMessage: (params) => inboxRpc.favoriteInboxMessage(params.id),
	unfavoriteInboxMessage: (params) => inboxRpc.unfavoriteInboxMessage(params.id),
