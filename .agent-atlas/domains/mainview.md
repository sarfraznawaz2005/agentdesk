...
- `MessageList` (line 77)
- `handler` (line 97)
- `scrollIfAtBottom` (line 194)
- `StreamingBubble` (line 353)
- `TypingRow` (line 362)
- `WaitingRow` (line 416)
...
- `onStreamError` (line 274)
- `onAgentStatus` (line 314)
- `onPlanPresented` (line 326)
- `onConversationTitleChanged` (line 350)
- `onConversationUpdated` (line 363)
- `onSwitchToConversation` (line 403)
- `bumpToTop` (line 417)
- `doSwitch` (line 428)
- `persistShellApprovalDecision` (line 446)
- `onNewMessage` (line 454)
- `onShellApprovalRequest` (line 516)
- `onAgentInlineStart` (line 537)
- `onAgentInlineComplete` (line 557)
- `onCompactionStarted` (line 602)
- `onConversationCompacted` (line 609)
- `onPmThinking` (line 630)
- `initChatEventHandlers` (line 658)
