...
- `emit` (line 301)
- `emitActivity` (line 556)
- `emitThinking` (line 601)

**Methods:**
- `sendMessage` (line 85)
- `_runPMProcessing` (line 185)
- `stopAll` (line 909)
- `stopAllAndReset` (line 918)
- `isStopped` (line 924)
- `setAbortAgentsFn` (line 929)
- `getProjectId` (line 934)
- `isProcessing` (line 939)
- `getActiveConversationId` (line 944)
- `getActiveMetadata` (line 949)
- `getQueuedAgentsSnapshot` (line 954)
- `presentPlan` (line 961)
- `moveKanbanTask` (line 968)
- `postDeterministicMessage` (line 973)
- `invokePMWithEvent` (line 984)
- `_handleStatusCommand` (line 999)
- `getDefaultProviderRow` (line 1011)
- `_loadSummarizationThreshold` (line 1062)
- `triggerSummarization` (line 1074)
- `_touchConversation` (line 1111)
- `autoTitleConversation` (line 1140)

**Exports:**
- `MessageMetadata` (line 39)
- `AgentEngineCallbacks` (line 39)
- `QueueEntry` (line 39)
