...
| `web_search` | Search the web for information (Tavily when a key is configured, DuckDuckGo fallback). |
...
| `src/bun/agents/tools/web.ts` | Web tools: `web_search` (Tavily→DuckDuckGo), `web_fetch`, `http_request` |
